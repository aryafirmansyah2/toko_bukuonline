					...
					<div class="row">
						<div class="col">
							<div class="header_content d-flex flex-row align-items-center justify-content-start">
								<div class="logo"><a href="index.php">DAYBOOK.ID</a></div>
								<nav class="main_nav">
									<ul>
										...
										<li class="hassubs">
											...
											<ul>
												<?php
													$query = "SELECT * from kategori  nama_kategori where deleted = 0";
									...
									<div class="col">
										<div class="home_slider_content" data-animation-in="fadeIn" data-animation-out="animate-out fadeOut">
											<div class="home_slider_title">
												<font size="5px">Toko Buku Yang Memiliki Buku Terbaik</font> Salafush Shalih.
											</div>
											<div class="home_slider_subtitle">Selamat Datang di DAYBOOK.id</div>
					...
					<div class="row">
						<div class="col">
							...
							<div class="product_grid">
								...
								where b.id_pengarang = p.id_pengarang and b.deleted = 0";
				...
				<div class="row">
					<div class="col">
						<div class="footer_content d-flex flex-lg-row flex-column align-items-center justify-content-lg-start justify-content-center">
							<div class="footer_logo"><a href="index.php">DAYBOOK.ID</a></div>
